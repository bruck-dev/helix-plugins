ITEM.name = "MWB Attachment"
ITEM.description = "MWB attachment base."
ITEM.category = "MWB Attachments"
ITEM.model = "models/props_junk/cardboard_box004a.mdl"
ITEM.width = 1
ITEM.height = 1

ITEM.isMWBAttachment = true
...
function ITEM:HasTool(client)
    ...
    if ix.config.Get("freeAttachments(MWB)", false) then return true end
