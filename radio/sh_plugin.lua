...
PLUGIN.author = "bruck"
PLUGIN.specialThanks = "nebulous.cloud, fauxzor"
PLUGIN.license = [[
...
ix.util.IncludeDir(PLUGIN.folder .. "/net", true)

-- I recommend checking out this list for radio stream links: https://github.com/deroverda/recommended-radio-streams